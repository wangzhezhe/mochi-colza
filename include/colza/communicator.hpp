...
class communicator {
 ...
 public:
  ...
  int reduce(const void *sendBuffer, void *recvBuffer, size_t elementSize,
             size_t count, COLZA_Operation_Func opFunc, int root);
  int ireduce(const void *sendBuffer, void *recvBuffer, size_t elementSize,
              size_t count, COLZA_Operation_Func opFunc, int root,
              request &req);
  int allreduce(const void *sendBuffer, void *recvBuffer, size_t size,
                COLZA_Operation_Func opFunc);
  int iallreduce(const void *sendBuffer, void *recvBuffer, size_t size,
