 ...
 */
#ifndef __COLZA_DYNAMICSCHEDULER_HPP
#define __COLZA_DYNAMICSCHEDULER_HPP
 ...
 public:
  ...
  na_addr_t _requestMonaAddressFromSSGMember(ssg_member_id_t member_id) {
    ...
    try {
      ...
      margo_addr_to_string(get_engine().get_margo_instance(), addr, &addr_size,
                           hg_addr);
      spdlog::trace(
          "_requestMonaAddressFromSSGMember member_id {} hg_addr {} providerid "
          "{}",
