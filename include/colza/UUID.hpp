 ...
 */
#ifndef __COLZA_UUID_UTIL_HPP
#define __COLZA_UUID_UTIL_HPP
...
namespace std {
    ...
    /**
     * @brief Specialization of std::hash for colza::UUID
     */
    template<>
    struct hash<colza::UUID> 
    {
        size_t operator()(const colza::UUID& id) const
        {
            return id.hash();
        }
    };
